...
tictactoe.geometry("400x400")
tictactoe.config(bg="yellow")
...
label = Label(text=player + " Turn ",font = ("Times New Roman",40,"bold"))
label.pack(side="top")

reset_button = Button(text="RESTART",font = ("Times New Roman",20),command = new_game,bg="black",fg="white")
